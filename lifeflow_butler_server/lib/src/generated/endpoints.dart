...
class Endpoints extends _i1.EndpointDispatch {
  ...
  void initializeEndpoints(_i1.Server server) {
    ...
    connectors['butler'] = _i1.EndpointConnector(
      ...
      methodConnectors: {
        'getDailyOverview': _i1.MethodConnector(
        ...
        'addTask': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['butler'] as _i4.ButlerEndpoint).addTask(
                session,
                params['task'],
              ),
        ),
        'updateTask': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['butler'] as _i4.ButlerEndpoint).updateTask(
                session,
                params['task'],
              ),
        ),
        'deleteTask': _i1.MethodConnector(
          ...
          call:
              (
                _i1.Session session,
                Map<String, dynamic> params,
              ) async => (endpoints['butler'] as _i4.ButlerEndpoint).deleteTask(
                session,
                params['id'],
              ),
        ),
        'getTaskHistory': _i1.MethodConnector(
          name: 'getTaskHistory',
          params: {},
          call:
              (
